    ...
    return (
        <div className="mt-4 mx-2  gap-3 grid grid-cols-2 sm:grid-cols-4" >
            {products?.map((item: any, index: number) => (
                <div key={index}  className=" grid max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"> 
                      <div className="pb-2 rounded-lg  overflow-visible ">
                      <img  className="object-cover h-48 w-full rounded-lg  " src={item.images[0]} alt="product image" />
                      </div>
                    <div className="px-4 pb-3 flex flex-col justify-between">
                        ...
                        <div className="flex flex-col items-center justify-between">
                            ...
                            <p className="text-red-500 text-[14px]">-%{item.discountPercentage}</p>
